...
var Clock = function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      var hours = (this.state.time.getHours() < 10 ? "0" : "") + this.state.time.getHours();
      var minutes = (this.state.time.getMinutes() < 10 ? "0" : "") + this.state.time.getMinutes();
      var seconds = (this.state.time.getSeconds() < 10 ? "0" : "") + this.state.time.getSeconds();
...
var Tabs = function (_React$Component) {
  ...
  function Tabs(props) {
    ...
    _this.tabs = [{ title: 'one', content: 'I am the first' }, { title: 'two', content: 'Second pane here' }, { title: 'three', content: 'Third pane here' }];
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'header',
              { className: '1', onClick: this.selectTab },
              this.tabs[0].title
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'header',
              { className: '2', onClick: this.selectTab },
              this.tabs[1].title
            )
          ),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'header',
              { className: '3', onClick: this.selectTab },
              this.tabs[2].title
            )
          )
        ),
...
var _clock = __webpack_require__(/*! ./clock */ "./clock.jsx");
...
var _tabs = __webpack_require__(/*! ./tabs */ "./tabs.jsx");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  _reactDom2.default.render(potato(), root);
});
